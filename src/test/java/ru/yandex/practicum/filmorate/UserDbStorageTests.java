...
public class UserDbStorageTests {
    ...
    public void getExceptionWhenIncorrectFriendIdInFriendship() {
        User user = User.builder().email("test@test.com").login("test").name("n").birthday(LocalDate.now()).build();
        storage.addUser(user);
    ...
    public void correctAddFriendship() {
        ...
        User user3 = User.builder().email("3@3.ru").login("u3").name("n3").birthday(LocalDate.now()).build();
        User user4 = User.builder().email("4@4.ru").login("u4").name("n4").birthday(LocalDate.now()).build();
    ...
    public void correctGetEmptyFriendsCrossing() {
        User user1 = User.builder().email("1@1.ru").login("u1").name("n1").birthday(LocalDate.now()).build();
        User user2 = User.builder().email("2@2.ru").login("u2").name("n2").birthday(LocalDate.now()).build();
        storage.addUser(user1);
