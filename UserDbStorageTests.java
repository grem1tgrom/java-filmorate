...
import org.springframework.test.annotation.DirtiesContext; // <-- ИМПОРТИРУЙТЕ ЭТО
...
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS) // <-- ДОБАВЬТЕ ЭТУ АННОТАЦИЮ
